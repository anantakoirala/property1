...
@section('title','Edit Interior Look')
@push('admin.styles')
<!-- Date Picker -->
...
<section class="content-header">
	<h1>Interior Look<small>edit</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('interior-look.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Edit Interior Look</h3>
				</div>
				<div class="box-body">
