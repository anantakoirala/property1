...
@section('title','Add Urgency Type')
@push('admin.styles')
<!-- Date Picker -->
...
<section class="content-header">
	<h1>Urgency Type<small>Add</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('urgency-type.store')}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Add Urgency Type</h3>
				</div>
				<div class="box-body">
