...
@section('title','Edit Near By Facility')
@push('admin.styles')
<!-- Date Picker -->
...
<section class="content-header">
	<h1>Near By Facility<small>edit</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('nearby-facility.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Edit Near By Facility</h3>
				</div>
				<div class="box-body">
