...
<div class="content">
	...
	@endif
<form method="post" action="{{route('saveHouse')}}" enctype="multipart/form-data" id="form">
	{{csrf_field()}}
	<div class="row">
		<div class="col-md-12">
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="completion_year" class="form-control" value="{{old('completion_year')}}">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="number" name="living_room" value="{{old('living_room')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
