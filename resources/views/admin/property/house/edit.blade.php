		...
		<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control property_category" name="advertisement_type">
								...
								<option value="{{$ad_type->slug}}" {{$detail->advertisement_type==$ad_type->slug?'selected':''}}>{{$ad_type->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control property_category" name="owner_info">
								...
								<option value="{{$owner_type->id}}" {{$detail->owner_info==$owner_type->id}}>{{$owner_type->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
				...
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control property_category" name="property_status">
								...
								<option value="{{$pro_stat->id}}" {{$detail->property_status==$pro_stat?'selected':''}}>{{$pro_stat->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="completion_year" class="form-control" value="{{$detail->completion_year}}">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Street</label>
							<input type="text" name="street" class="form-control" value="{{$detail->street}}">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" hidden=""   name="lat" id="lat" value="{{$detail->lat}}">
							<input type="text" hidden=""  name="lng" id="lng" value="{{$detail->lng}}">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Building price per Sqft.</label>
							<input type="number" name="sqft_price" value="{{$detail->sqft_price}}" class="form-control">
						</div>
					</div>
				...
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control property_category" name="urgency_id">
								...
								<option value="{{$urgency_type->id}}" >{{$urgency_type->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="radio" {{$detail->broker_repsponse=='yes'?'checked':''}} name="broker_response" value="yes">Yes
							<input  type="radio" name="broker_response" value="no" {{$detail->broker_repsponse=='no'?'checked':''}}>No
						</div>
					</div>
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							<label>Exterior Looks</label>
							<select multiple="multiple" class="js-example-basic-multiple form-control exteriorlooks" name="exterior_look_id[]">
								@foreach($exterior_looks as $exterior_look)
								<option value="{{$exterior_look->id}}">{{$exterior_look->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Interior Looks</label>
							<select multiple="multiple" class="js-example-basic-multiple form-control interiorlooks" name="interior_look_id[]">
								@foreach($interior_looks as $interior_look)
								<option value="{{$interior_look->id}}">{{$interior_look->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
				...
				<div class="box-body">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="number" name="kitchens" value="{{$detail->kitchens}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Floors</label>
							<input type="number" name="floors" value="{{$detail->floors}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Bedrooms</label>
							<input type="text" name="bedrooms" value="{{$detail->bedrooms}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Bathrooms</label>
							<input type="text" name="bathrooms" value="{{$detail->bathrooms}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Shutters</label>
							<input type="text" name="shutters" value="{{$detail->shutters}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Living Rooms</label>
							<input type="text" name="living_room" value="{{$detail->living_room}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Rooms Per Floor</label>
							<input type="text" name="room_per_floor" value="{{$detail->rooms_per_floor}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Parking</label>
							<input type="text" name="parking" value="{{$detail->parking}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Garage</label>
							<input type="text" name="garage" value="{{$detail->garage}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Size Of Pillars</label>
							<input type="text" name="size_of_pillars" value="{{$detail->size_of_pillars}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Pillars</label>
							<input type="text" name="no_of_pillars" value="{{$detail->no_of_pillars}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Source Of Water</label>
							<input type="text" name="source_of_waters" value="{{$detail->source_of_waters}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Capacity Of Water Tank</label>
							<input type="text" name="capacity_of_water_tank" value="{{$detail->capacity_of_water_tank}}" class="form-control">
						</div>
					</div>
				...
				<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="land_perimeter" value="{{$detail->land_perimeter}}" class="form-control">
						</div>
					</div>
				...
				<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="land_area_in_sqft_lal" value="{{$detail->land_area_in_sqft_lal}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Land Area In Meters</label>
							<input type="text" name="land_area_in_meters_lal" value="{{$detail->land_area_in_meters_lal}}" class="form-control">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control" name="elevation">
								...
								<option value="{{$elevation->name}}" {{$detail->elevation==$elevation->id?'selected':''}}>{{$elevation->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
						...
						<div class="form-group">
					   	...
					   	<div id="wrapper">
                			<div id="image-holder">
                				...
                				<img src="{{asset('images/property/thumbnail')}}/{{$detail->feature_image}}" class="thumb-image" width="50%">
                				@endif
                			</div>
              			</div>
						</div>
