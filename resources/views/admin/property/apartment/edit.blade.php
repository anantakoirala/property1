...
<section class="content-header">
	<h1>Apartment<small>edit</small></h1>
	<ol class="breadcrumb">
...
<form method="post" action="{{route('property.update',$detail->id)}}" enctype="multipart/form-data" id="form">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title"><b>Apartment Builder</b></h3>
				</div>
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							<label>Company Name</label>
							<input type="text" name="company_name" value="{{$detail->company_name}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Company Address</label>
							<input type="text" name="company_address" value="{{$detail->company_address}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="form-control property_category" name="owner_info">
								...
								<option value="{{$owner_type->id}}" {{$detail->owner_info==$owner_type?'selected':''}}>{{$owner_type->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
			...
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title"><b>Apartment Info</b></h3>
				</div>
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							<label>Apartment Detail</label>
							<input type="text" name="apartment_detail" value="{{$detail->apartment_detail}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Appartment Area In Sqft</label>
							<input type="text" name="land_area_in_sqft_lal" value="{{$detail->land_area_in_sqft_lal}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Appartment Area In Meters</label>
				...
				<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="number" name="bedrooms" value="{{$detail->bedrooms}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Bathrooms</label>
							<input type="number" name="bathrooms" value="{{$detail->bathrooms}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Shutters</label>
							<input type="number" name="shutters" value="{{$detail->shutters}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Boundry</label>
							<input type="text" name="boundry" value="{{$detail->boundry}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Rooms Per Floor</label>
							<input type="number" name="room_per_floor" value="{{$detail->room_per_floor}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Parking</label>
							<input type="number" name="parking" value="{{$detail->parking}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control" name="elevation">
								...
								<option value="{{$elevation->name}}" {{$detail->elevation==$detail->elevation?'selected':''}}>{{$elevation->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
