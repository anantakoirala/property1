...
<section class="content-header">
	<h1>Apartment<small>add</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('saveApartment')}}" enctype="multipart/form-data" id="form">
	{{csrf_field()}}
	<div class="row">
		<div class="col-md-12">
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="number" name="sqft_price" value="{{old('sqft_price')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="box-body">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="apartment_detail" value="{{old('apartment_detail')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="box-body">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="number" name="kitchens" value="{{old('kitchens')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Floors</label>
							<input type="number" name="floors" value="{{old('floors')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="number" name="shutters" value="{{old('shutters')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Boundry</label>
							<input type="text" name="boundry" value="{{old('boundry')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Rooms Per Floor</label>
							<input type="number" name="room_per_floor" value="{{old('rooms_per_floor')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label>Garage</label>
							<input type="text" name="garage" value="{{old('garage')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Size Of Pillars</label>
							<input type="text" name="size_of_pillars" value="{{old('size_of_pillars')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Number Of Pillars</label>
							<input type="text" name="no_of_pillars" value="{{old('no_of_pillars')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Source Of Water</label>
							<input type="text" name="source_of_waters" value="{{old('source_of_waters')}}" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label>Capacity Of Water Tank</label>
							<input type="text" name="capacity_of_water_tank" value="{{old('capacity_of_water_tank')}}" class="form-control">
						</div>
					</div>
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select multiple="multiple" class="js-example-basic-multiple form-control" name="exterior_look_id[]">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select multiple="multiple" class="js-example-basic-multiple form-control" name="interior_look_id[]">
