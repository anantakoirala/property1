...
<section class="content-header">
	<h1>OwnerType<small>add</small></h1>
	<ol class="breadcrumb">
		<li><a href=""><i class="fa fa-dashboard"></i>Dashboard</a></li>
		<li><a href="">OwnerType</a></li>
		<li><a href="">Add</a></li>
	</ol>
</section>
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('owner-type.store')}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Add Owner Type</h3>
				</div>
				<div class="box-body">
