...
@section('title','Edit Commission Type')
@push('admin.styles')
<!-- Date Picker -->
...
<section class="content-header">
	<h1>Commission Type<small>edit</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('commission-type.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Edit Commission Type</h3>
				</div>
				<div class="box-body">
